...
from app.r2_storage import upload_file_to_r2, download_file_from_r2, r2_enabled
...
def r2_test():
    """
    Temporary Cloudflare R2 upload/download test.

    This route writes a small text file to /tmp, uploads it to R2,
    downloads it again, and returns the downloaded content.

    Remove this route after the R2 connection has been verified.
    """
    if not r2_enabled():
