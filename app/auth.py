...
<div class="bp-auth-card">
  <div class="bp-auth-logo"><div class="bp-auth-logo-mark">BP</div>BIMPruef</div>
  <h1>BIMPruef Login</h1>
  <p class="bp-text-secondary">Sign in with your email and password to access your projects.</p>
  {_invite_request_notice()}
  {err}
  <form method="POST" action="/auth/login" autocomplete="on">
    <label class="bp-label">Email</label>
    <input class="bp-input" type="email" name="email" value="{_e(email)}" required autocomplete="email">

    <label class="bp-label">Password</label>
    <div class="password-wrap">
      <input class="bp-input" id="login-password" type="password" name="password" required
             autocomplete="current-password">
      <button id="login-password-btn" class="bp-btn bp-btn--secondary bp-btn--sm show-password-btn" type="button"
              onclick="togglePassword('login-password','login-password-btn')">Show</button>
    </div>

    <button class="bp-btn bp-btn--primary bp-w-full" style="justify-content:center;margin-top:18px" type="submit">Sign in</button>
  </form>

  <div class="small bp-text-muted">
    No account yet? <a href="/auth/signup">Create account</a>
  </div>
</div>""")
...
<div class="bp-auth-card">
  ...
  <p class="bp-text-secondary">Use your valid email address, your invitation code, and a strong password.</p>
  {_invite_request_notice()}
  {err}
  <form method="POST" action="/auth/signup" autocomplete="on">
    <label class="bp-label">Invitation code</label>
    <input class="bp-input" type="text" name="invite_code" value="{_e(invite_code)}" required
           autocomplete="off">
    ...
    <label class="bp-label">Password</label>
    <div class="password-wrap">
      <input class="bp-input" id="signup-password" type="password" name="password" required
             autocomplete="new-password">
      <button id="signup-password-btn" class="bp-btn bp-btn--secondary bp-btn--sm show-password-btn" type="button"
    ...
    <button class="bp-btn bp-btn--primary bp-w-full" style="justify-content:center;margin-top:18px" type="submit">Create account</button>
  </form>
