...
def project_dashboard(request: Request, project_id: str):
    ...
    try:
        from app.issue_storage import get_project_issue_count
        issue_count = get_project_issue_count(account_id, project_id)
    except Exception:
        issue_count = 0
...
def project_model_clash_legacy_redirect(request: Request, project_id: str):
