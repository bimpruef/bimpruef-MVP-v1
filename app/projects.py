...
def project_documents(
    ...
    all_folders = []
    # flat folder list for upload target selection
...
def project_settings(
    ...
    body = (
        ...
        '<div class="card" style="border-color:var(--accent2);background:#170d16">'
        '<h2 style="font-size:16px;margin-bottom:8px;color:#ffb3b3">Projekt vollständig löschen</h2>'
        '<p style="color:var(--muted);font-size:12px;margin-bottom:12px">'
        'Diese Aktion löscht das Projekt endgültig aus PostgreSQL sowie alle zugehörigen '
        'IFC-Dateien, Metadaten, lokalen Session-Dateien, Clash-Caches und R2-Objekte unter der Projekt-Session. '
        ...
        f'<input type="text" name="confirm_project_name" required autocomplete="off" '
        f'placeholder="{project_name_escaped}">'
        '<label>Endgültige Bestätigung</label>'
        '<input type="text" name="confirm_text" required autocomplete="off" placeholder="DELETE">'
        '<div style="font-size:11px;color:var(--muted);margin-top:8px">'
        'Gib exakt den Projektnamen ein und schreibe zusätzlich DELETE in das zweite Feld.'
        '</div>'
