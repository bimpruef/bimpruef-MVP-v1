...
def delete_session(session_id: str) -> None:
    ...
    Für temporäre Sessions werden zusätzlich die bekannten Slot-Dateien aus R2
    gelöscht. Projekt-Sessions sollten nicht über diese Funktion gelöscht
    werden, sondern über Projektlogik geschützt bleiben.
    """
    session_id = validate_session_id(session_id)
